...
def run_all_methods(gmm_set, num):
    ...
    plot_gmms.plot_mult_gauss(weighted)
    # for j in weighted:
    #     print(j)
...
if __name__ == "__main__":
    ...
    gmm_00 = [[5.0, 0.6, 0.5, 0.5], [10.0, 1.5, 0.5, 1.0]]
    gmm_01 = [[7.0, 0.4, 0.5, 0.5], [14.0, 1.3, 0.5, 1.0]]

    gmm_02 = [[1.0, 2.0, 0.5, 0.5], [3.3, 5.0, 0.5, 1.0]]
    gmm_03 = [[11.2, 0.6, 0.5, 0.5], [33, 1.7, 0.5, 1.0]]
